...
class CustomerInfolist
{
        ...
        return $schema
            ->components([
                Tabs::make()
                    ->tabs([
                        Tab::make('概览')
                            ->schema(self::overviewSections()),
                        Tab::make('跟进')
                            ->schema(self::followUpSections()),
                        Tab::make('联系人')
                            ->schema(self::contactSections()),
                        Tab::make('交易')
                            ->schema(self::dealSections()),
                        Tab::make('附件与历史')
                            ->schema(self::historySections()),
                    ])
                    ->columnSpanFull(),
            ]);
    }

    private static function overviewSections(): array
    {
        return [
            Section::make('客户档案')
                ->schema([
    ...
    private static function followUpSections(): array
    {
        return [
            Section::make('跟进记录')
                ->schema([
                    RepeatableEntry::make('followups_overview')
                        ->hiddenLabel()
    ...
    private static function dealSections(): array
    {
        return [
            Section::make('商机')
                ->schema([
    ...
    private static function historySections(): array
    {
        return [
            Section::make('附件')
                ->schema([
